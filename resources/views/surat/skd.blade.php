...
<body>
    ...
    <div class="content">
        <p class="title">SURAT KETERANGAN DOMISILI</p>
        ...
        <table>
            ...
            <tr>
                <td>Alamat</td>
                <td>: {{ $data_pengajuan['alamat_domisili'] }}</td>
            </tr>
        </table>

        <p>Dengan ini menerangkan bahwa orang yang bersangkutan benar tinggal berdomisili di Kampung Sukajadi Kecamatan
            Kasui Kabupaten Way Kanan.</p>

        <p>Demikian Surat Keterangan Domisili ini dibuat dengan sebenar-benarnya untuk dapat dipergunakan sebagaimana
            mestinya.</p>
    </div>
