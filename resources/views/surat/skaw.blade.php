...
<body>
    ...
    <div class="content">
        <p class="title">SURAT KETERANGAN AHLI WARIS</p>
        ...
        <p>Adalah benar sebagai <strong>AHLI WARIS</strong> dari almarhum:</p>
        <table>
            <tr>
                <td>Nama</td>
            ...
            <tr>
                <td>Alamat</td>
                <td>: {{ $data_pengajuan['alamat_almarhum'] }}</td>
            </tr>
        </table>

        <p>Demikian surat keterangan ahli waris ini dibuat dengan sebenarnya dan untuk dapat dipergunakan sebagaimana
            mestinya.</p>
    </div>
        ...
        <table>
            <tr>
                <td style="text-align: center;">
                    ...
                    <p></p>
                    <p></p>
                    <p>Ahli Waris</p><img src="{{ public_path('storage/logos/ttd.jpg') }}" style="visibility: hidden"
